            ...
            >
                ...
                <template slot="table-row" slot-scope="props">
                    <span v-if="props.column.field == 'actions'">
                        <div>
                            ...
                            >
                                ...
                                <b-dropdown-item
                                    title="PDF"
                                    @click="Return_PDF(props.row, props.row.id)"
                                >
                                    <i
                    ...
                    >
                        <router-link
                            :to="
                                '/app/purchases/detail/' + props.row.purchase_id
                            "
                        >
                            <span class="ul-btn__text ml-1">{{
                                props.row.purchase_ref
                            }}</span>
                        </router-link>
                    </div>
                </template>
