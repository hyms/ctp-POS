<template>
    <div class="main-content">
        <breadcumb
            :page="$t('CreatePurchaseReturn')"
            :folder="$t('ListReturns')"
        />
        <div
            v-if="isLoading"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        ...
                                                        {{
                                                            purchase_return.TaxNet.toFixed(
                                                                2
                                                            )
                                                        }}
                                                        ({{
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ currentUser.currency }}
                                                    {{
                                                        purchase_return.discount.toFixed(
                                                            2
                                                        )
                                                    }}
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ currentUser.currency }}
                                                    {{
                                                        purchase_return.shipping.toFixed(
                                                            2
                                                        )
                                                    }}
                                                </td>
        ...
        verifiedForm() {
            if (this.details.length <= 0) {
                ...
                if (count === 0) {
                    this.makeToast(
                        "warning",
                        this.$t("Please_add_return_quantity"),
                        this.$t("Warning")
                    );
        ...
        GetElements() {
            ...
            axios
                ...
                .then((response) => {
                    this.details = response.data.details;
                    this.purchase_return = response.data.purchase_return;
                    this.purchase_return.date = new Date()
                        .toISOString()
                        .slice(0, 10);
                    this.Calcul_Total();
