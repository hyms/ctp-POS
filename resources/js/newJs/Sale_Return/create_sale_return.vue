        ...
        GetElements() {
            ...
            axios
                ...
                .then((response) => {
                    this.details = response.data.details;
                    this.sale_return = response.data.sale_return;
                    this.sale_return.date = new Date()
                        .toISOString()
                        .slice(0, 10);
                    this.Calcul_Total();
