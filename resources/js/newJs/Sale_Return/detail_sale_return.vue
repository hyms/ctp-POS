                ...
                <b-col md="12" class="mb-5">
                    <router-link
                        v-if="
                            ...
                            currentUserPermissions.includes('Sale_Returns_edit')
                        "
                        title="Edit"
                ...
                <div class="invoice-print">
                    <b-row class="justify-content-md-center">
                        <h4 class="font-weight-bold">
                            {{ $t("ReturnDetail") }} : {{ sale_return.Ref }}
                        </h4>
                    </b-row>
                    <hr />
                    <b-row class="mt-5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ currentUser.currency }}
                                            {{
                                                sale_return.discount.toFixed(2)
                                            }}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            {{ currentUser.currency }}
                                            {{
                                                sale_return.shipping.toFixed(2)
                                            }}
                                        </td>
                                    </tr>
                                    <tr>
