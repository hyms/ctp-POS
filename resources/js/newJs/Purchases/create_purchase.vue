                ...
                <b-form @submit.prevent="submit_Update_Detail">
                    <b-row>
                        ...
                        <b-col lg="6" md="6" sm="12">
                            ...
                            >
                                ...
                                >
                                    ...
                                    ></b-form-input>
                                    <b-form-invalid-feedback id="cost-feedback"
                                        >{{ validationContext.errors[0] }}
                                    </b-form-invalid-feedback>
                                </b-form-group>
                            </validation-provider>
                        ...
                        <b-col lg="12" md="12" sm="12" v-show="detail.is_imei">
                            <b-form-group
                                :label="$t('Add_product_IMEI_Serial_number')"
                            >
                                <b-form-input
                                    label="Add_product_IMEI_Serial_number"
                                    v-model="detail.imei_number"
                                    :placeholder="
                                        $t('Add_product_IMEI_Serial_number')
                                    "
                                ></b-form-input>
                            </b-form-group>
                        </b-col>
...
export default {
    ...
    methods: {
        ...
        search() {
            ...
            if (
                this.purchase.warehouse_id != "" &&
                this.purchase.warehouse_id != null
            ) {
        ...
        Calcul_Total() {
            ...
            this.GrandTotal = parseFloat(
                total_without_discount +
                    this.purchase.TaxNet +
                    this.purchase.shipping
            );
