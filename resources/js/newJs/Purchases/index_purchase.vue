            ...
            >
                ...
                <template slot="table-row" slot-scope="props">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <b-dropdown-item
                                    title="Show"
                                    :to="
                                        '/app/purchases/detail/' + props.row.id
                                    "
                                >
                                    <i
                                ...
                                <b-dropdown-item
                                    ...
                                    v-if="
                                        ...
                                        props.row.purchase_has_return == 'no'
                                    "
                                ...
                                <b-dropdown-item
                                    ...
                                    "
                                    :to="
                                        '/app/purchases/purchase_return/' +
                                        props.row.id
                                    "
                                >
                                    <i
                                        class="nav-icon i-Back font-weight-bold mr-2"
                                    ></i>
                                    {{ $t("Purchase_Return") }}
                                </b-dropdown-item>
                                ...
                                <b-dropdown-item
                                    ...
                                    v-if="
                                        ...
                                        props.row.purchase_has_return == 'yes'
                                    "
                                    :to="
                                        '/app/purchase_return/edit/' +
                                        props.row.purchasereturn_id +
                                        '/' +
                                        props.row.id
                                    "
                                >
                                ...
                                >
                                    <i
                                        class="nav-icon i-Money-Bag font-weight-bold mr-2"
                                    ></i>
                                    {{ $t("ShowPayment") }}
                                </b-dropdown-item>
                                ...
                                >
                                    <i
                                        class="nav-icon i-Add font-weight-bold mr-2"
                                    ></i>
                                    {{ $t("AddPayment") }}
                                </b-dropdown-item>
                                ...
                                <b-dropdown-item
                                    title="Email"
                                    @click="
                                        Purchase_Email(props.row, props.row.id)
                                    "
                                >
                                    <i
                    ...
                    <div v-else-if="props.column.field == 'Ref'">
                        ...
                        <br />
                        <small v-if="props.row.purchase_has_return == 'yes'"
                            ...
                            <tbody>
                                ...
                                <tr v-for="facture in factures">
                                    ...
                                    <td>
                                        ...
                                        {{ formatNumber(facture.montant, 2) }}
                                    </td>
                        ...
                        <b-col lg="4" md="12" sm="12">
                            ...
                            >
                                <b-form-group :label="$t('Paying_Amount')">
                                    <b-form-input
                                        @keyup="
                                            Verified_paidAmount(facture.montant)
                                        "
                                        label="Amount"
...
export default {
    ...
    methods: {
        ...
        Submit_Payment() {
            this.$refs.Add_payment.validate().then((success) => {
                if (!success) {
                    ...
                    this.facture.montant > this.facture.received_amount
                ) {
                    this.makeToast(
                        "warning",
                        this.$t(
        ...
        Edit_Payment(facture) {
            ...
            this.facture.received_amount = parseFloat(
                facture.montant + facture.change
            ).toFixed(2);
