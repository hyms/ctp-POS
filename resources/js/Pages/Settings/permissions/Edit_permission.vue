<template>
  ...
  <!--                              </label>-->
  <!--                            </b-col>-->
  <!--                            &lt;!&ndash;Reports_payments_Sale_Return&ndash;&gt;-->
  <!--                            <b-col md="12">-->
  <!--                              <label class="checkbox checkbox-outline-primary">-->
  <!--                                <input-->
  <!--                                  type="checkbox"-->
