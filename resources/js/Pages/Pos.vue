...
//         .then(response => {
//           client.values = response.data.clients;
//           this.warehouses = response.data.warehouses;
//           this.categories = response.data.categories;
//           this.brands = response.data.brands;
//           // this.pos_settings = response.data.pos_settings;
//           sale.value.warehouse_id = response.data.defaultWarehouse;
//           sale.value.client_id = response.data.defaultClient;
//           this.getProducts();
...
//         payment.value.received_amount = this.formatNumber(GrandTotal.value., 2);
    ...
    <v-row>
      ...
      <v-col md="5" cols="12">
        <v-card class="card-order">
          ...
          <v-card-text>
            <v-form @submit.prevent="Submit_Pos">
              <v-row>
                <!-- Customer -->
                <v-col cols="12">
                  <v-autocomplete
                  ...
                  <!--                        <v-input-group slot-scope="{ valid, errors }" class="input-customer">-->
                  <!--                          <v-select-->
                  ...
                  <!--                            <v-button variant="primary" @click="New_Client()">-->
                  <!--                              <span>-->
                  ...
                  <!--                        <v-form-group slot-scope="{ valid, errors }" class="mt-2">-->
                  <!--                          <v-select-->
                  <!--                              :class="{'is-invalid': !!errors.length}"-->
                  <!--                              :state="errors[0] ? false : (valid ? true : null)"-->
      ...
      <!--                  &lt;!&ndash; Calcul Grand Total &ndash;&gt;-->
      ...
      <!--                      </v-col>-->
      <!--                      <v-col md="6" sm="12">-->
      <!--                        <v-button type="submit" variant="success ripple mt-1 btn-rounded btn-block">-->
      ...
      <!--            &lt;!&ndash; Update Detail Product &ndash;&gt;-->
      ...
      <!--        &lt;!&ndash; Card right Of Products &ndash;&gt;-->
      <!--        <v-col md="7">-->
      <!--          <v-card class="list-grid">-->
      <!--            <v-row>-->
      <!--              <v-col md="6">-->
      <!--                <button v-v-toggle.sidebar-category class="btn btn-outline-info mt-1 btn-block">-->
      ...
      <!--                      <span-->
      <!--                          class="badge badge-primary w-15 w-sm-100 mv-2"-->
