<template>
    ...
    <!--            </b-col>-->
    <!--            &lt;!&ndash; /.col &ndash;&gt;-->
    <!--            &lt;!&ndash; /.Total Returns Sales &ndash;&gt;-->
    <!--            <b-col md="4" sm="12">-->
    <!--              <div class="card card-icon text-center mb-30">-->
    <!--                <div class="card-body">-->
    <!--                  <i class="i-Data-Upload"></i>-->
    ...
    <!--            </b-col>-->
    <!--            &lt;!&ndash; /.col &ndash;&gt;-->
    <!--            &lt;!&ndash; /.Total Returns Purchases &ndash;&gt;-->
    <!--            <b-col md="4" sm="12">-->
    <!--              <div class="card card-icon text-center mb-30">-->
    <!--                <div class="card-body">-->
    <!--                  <i class="i-Data-Upload"></i>-->
    ...
    <!--            &lt;!&ndash; /.Profit Using FIFO METHOD &ndash;&gt;-->
    <!--            <b-col md="4" sm="12">-->
    <!--              <div class="card card-icon text-center mb-30">-->
    <!--                <div class="card-body">-->
    <!--                  <i class="i-Data-Upload"></i>-->
    ...
    <!--            &lt;!&ndash; /.Paiements Received &ndash;&gt;-->
    <!--            <b-col md="4" sm="12">-->
    <!--              <div class="card card-icon text-center mb-30">-->
    <!--                <div class="card-body">-->
    <!--                  <i class="i-Data-Upload"></i>-->
